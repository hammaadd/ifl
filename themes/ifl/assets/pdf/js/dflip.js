...
(function dFlip(DFLIP, $) {
  ...
  var defaults = DFLIP.defaults = {
    ...
    pdfjsSrc: "assets/pdf/js/pdf.min.js",
    //(NON-OPTION) source link for PDFcompatibility.JS file
    pdfjsCompatibilitySrc: "assets/pdf/js/compatibility.js",
    //(NON-OPTION) source link for PDF.WORKER.JS file
    pdfjsWorkerSrc: "assets/pdf/js/pdf.worker.min.js",
    //(NON-OPTION) source link for THREE.JS file
    threejsSrc: "assets/pdf/js/three.min.js",
    //(NON-OPTION) source link for MOCKUP.JS file
    mockupjsSrc: "assets/pdf/js/mockup.min.js",
    //(NON-OPTION) File path to the trun sound
    soundFile: "assets/pdf/sound/turn2.mp3",
    imagesLocation: "images",
    imageResourcesPath: "assets/pdf/images/pdfjs/",
