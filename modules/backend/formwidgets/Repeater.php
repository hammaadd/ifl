...
class Repeater extends FormWidgetBase
{
    ...
    /**
     * @var bool Determines if a child repeater has made an AJAX request to add an item
     */
    protected $childAddItemCalled = false;

    /**
     * @var int Determines which child index has made the AJAX request to add an item
     */
    ...
    protected function processItems()
    {
        ...
        // If no value is available but a child repeater has added an item,
        // add a "stub" repeater item
    ...
    /**
     * checkAddItemRequest determines the repeater that has triggered an AJAX request to add an item
     */
